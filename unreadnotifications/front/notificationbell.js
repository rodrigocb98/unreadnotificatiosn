/**
 * Unread Notifications Bell Plugin for GLPI - VERSIÓN UNIFICADA
 * Incluye sonidos y vista previa
 */
/** */
/**
...
class NotificationSoundManager {
    ...
    loadRealSounds() {
        try {
            ...
            const pluginWebroot = window.GLPI_PLUGIN_WEBROOT_UNREAD || '/unadm-10/plugins/unreadnotifications';
...
window.createNotificationBell = function() {
    ...
    // HTML de la campana
   // HTML de la campana - Versión mejorada
var bellHTML = `
    <li id="unread-notifications-bell" class="nav-item dropdown notification-bell-container">
        ...
        <div class="dropdown-menu dropdown-menu-end notification-dropdown">
            <div class="d-flex justify-content-between align-items-center p-2 border-bottom">
                ...
                <button type="button" class="btn btn-sm btn-outline-secondary" id="refresh-notifications-btn">
...
window.loadNotifications = function() {
    var pluginWebroot = window.GLPI_PLUGIN_WEBROOT_UNREAD || '/unadm-10/plugins/unreadnotifications';
...
window.updateNotificationBell = function(count, details, previousCount = null) {
    ...
    var glpiRoot = window.GLPI_ROOT_UNREAD || '/unadm-10';
                ...
                <div class="notification-item mb-2 p-2 border rounded">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="flex-grow-1">
                            <a href="${window.GLPI_ROOT_UNREAD || '/unadm-10'}/front/ticket.form.php?id=${ticket.id}" 
        ...
        items.changes_group.forEach(change => {
            html += `
                <div class="notification-item mb-2">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="flex-grow-1">
                            <a href="${window.GLPI_ROOT_UNREAD || '/unadm-10'}/front/change.form.php?id=${change.id}" 
                               class="text-dark text-decoration-none" target="_blank">
